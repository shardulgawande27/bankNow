...
const BLogin = () => {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost:3001/login/banker", {
        username,
        password,
      });
    ...
    <>
      ...
      >
        <div className="w-[40%] h-[100%] flex flex-col justify-center items-center bg-#205bd4">
          ...
          <p className=" text-white">Effortless Banking, Every Time.</p>
        </div>

        <div className="w-[60%] h-[100%] bg-white text-white flex flex-col items-center relative">
          <div
            className="mt-8 text-5xl flex justify-center items-center text-black font-bold "
            style={{ marginTop: "130px" }}
          >
            Banker Login! 👋
          </div>
          <p className="text-black mt-4">Effortless Banking, Every Time.</p>
          ...
          <div className="absolute top-5 right-5 flex items-center">
            ...
            />
            <span className="text-lg text-black font-bold">Bank Now</span>
          </div>
          <form
            className=" flex flex-col border rounded-lg w-[500px] h-auto items-center p-9 relative text-[#7D8893]"
          ...
          >
            ...
            <Link to="/login" className="w-[97%] mt-4">
              <button
                className="w-full h-[40px] bg-[#205bd4] text-white font-semibold"
                type="submit"
                style={{ borderRadius: "6px" }}
